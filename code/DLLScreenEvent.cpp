...
//     myDLL.drawList(window, opacity, nodeText);
// }
...
//         drawType = insertLL1;
//         myDLL.insertAfterIndex(insertData, insertIndex);
//         insertIndex++;
//         markFirst = 1;
//     }
// }
...
//         sf::sleep(sf::milliseconds(500));
//     }
//     myDLL.drawDeleteNode(window, deleteIndex, nodeOpacity, deleteNodeOpacity, nodeText);
//     LLCodeBlock.drawDeleteCodeBlock(window);
...
//     myDLL.drawUpdateChangeNum(window, updateIndex, updateData, numberOpacity, fadeColor, nodeText);
//     LLCodeBlock.drawUpdateCodeBlock(window);
...
//             myDLL.insertAfterIndex(updateData, updateIndex - 1);
//         }
//     }
//     else {
//         if (numberOpacity == 0)
...
//     myDLL.drawUpdateRevert(window, updateIndex, fadeOutlineColor, fadeNumberColor, nodeText);
//     LLCodeBlock.drawUpdateCodeBlock(window);
//     LLCodeBlock.drawUpdateCodeBlockMultiLine(window, 2, 4);
//     if (flashTimer.getElapsedTime().asSeconds() >= nodeConstants::flashDuration.asSeconds()) {
//         drawType = showcaseLL;
